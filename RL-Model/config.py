...
EVALUATION_INTERVAL = 100  # test the agent every n timesteps
NUM_EPOCHS = 4 # number of epochs to train the agent

# rewards
REWARD_FOR_LIKED_SONG = 2
REWARD_FOR_UNLIKED_SONG = -2
REWARD_FOR_SAME_SONG = -10

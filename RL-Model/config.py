...
TRAINING_TIMESTEPS = 250_000 # number of training timesteps
EPISODE_LENGTH = 500 # maximum number of recommendations until the episode is done (same for eval)
LEARNING_STARTS = 7500 # number of steps before the first update of the model (warmup)

# epsilon-greedy exploration
EXPLORATION_EPSILON_INITIAL = 0.5 # initial value of epsilon
...
SONG_HISTORY_SIZE = 25 # number of songs that are remembered for the same song penalty
